...
public class Svg {
    ...
    private static final String SVG_LINE_TEMPLATE = "<line x1='40' y1='10' x2='40' y2='610' style='stroke:#000000; marker-start: url(#beginArrow); marker-end: url(#endArrow);' />";
    public void addLine(int x1, int y1, int x2, int y2, String style) {
        svg.append(SVG_LINE_TEMPLATE);
    }
